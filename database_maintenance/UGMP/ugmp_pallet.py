...
class UGMPPallet(Pallet):

    def ship(self):
        try:
            sdeconnection = join(self.garage, 'UGMP', 'DC_sde@UGMP@ugmp.agrc.utah.gov.sde')
            ...
            con = join(self.garage, 'UGMP', 'DNR_UGMPADMIN@UGMP@ugmp.agrc.utah.gov.sde')
